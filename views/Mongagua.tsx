...
export default function Mongagua() {
    ...
    async function buscaTempo() {
        const response = await Api.get('weather?array_limit=7&fields=only_results,temp,city_name,forecast,condition,max,min,description,date,moon_phase,full_date,weekday,humidity,cloudiness,rain,rain_probability,wind_speedy,sunrise,sunset&key=c0cd1deb&city_name=Mongaguá,SP');
